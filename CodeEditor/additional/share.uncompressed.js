...
(function() {
  ...
  text.api = {
    ...
    insert: function(username, pos, text, callback) {
      var op;
      op = [
        {
          p: pos,
    ...
    del: function(username, pos, length, callback) {
      var op;
      ...
      return this.on('remoteop', function(op) {
        ...
        for (_i = 0, _len = op.length; _i < _len; _i++) {
          ...
          if (component.i !== void 0) {
            _results.push(this.emit('insert', component.meta.username, component.p, component.i));
          } else {
            _results.push(this.emit('delete', component.meta.username, component.p, component.d));
          }
        }
        return _results;
      });
